...
<head>
    ...
    <style>
        ...
        body {
            ...
            position: relative; /* Postavljamo relativnu poziciju za body */
            min-height: 100vh; /* Postavljamo minimalnu visinu body-ja na visinu ekrana */
        }
        .navbar-brand img {
            max-height: 50px;
            margin-right: 10px;
        ...
        /* Stilizacija za sliku u donjem levom uglu */
        .bottom-left-image {
            position: absolute;
            bottom: 10px; /* Udaljenost od donje ivice */
            left: 10px; /* Udaljenost od leve ivice */
            max-width: 100px; /* Postavljamo maksimalnu širinu slike */
            height: auto;
        }
    </style>
</head>
